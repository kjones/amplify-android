...
final class IterableDeserializer implements JsonDeserializer<Iterable<Object>> {
    ...
    private final AppSyncGraphQLRequest<PaginatedResult<Object>> request;

    IterableDeserializer(AppSyncGraphQLRequest<PaginatedResult<Object>> request) {
    ...
    private PaginatedResult<Object> buildPaginatedResult(Iterable<Object> items, JsonElement nextTokenElement) {
        AppSyncGraphQLRequest<PaginatedResult<Object>> requestForNextPage = null;
